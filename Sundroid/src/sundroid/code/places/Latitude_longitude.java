...
//To parse - http://maps.googleapis.com/maps/api/geocode/xml?address=variable&sensor=false
...
public class Latitude_longitude {
	...
	// ===========================================================
		...
		private Geometry lat_lng_pair = null;

		/**
		 * @return the lat_lng_pair
		 */
		public Geometry getLat_lng_pair() {
			return lat_lng_pair;
		}

		/**
		 * @param lat_lng_pair the lat_lng_pair to set
		 */
		public void setLat_lng_pair(Geometry lat_lng_pair) {
			this.lat_lng_pair = lat_lng_pair;
		}
